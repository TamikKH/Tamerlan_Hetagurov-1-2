...
|   3    |   1    | Выполнено  | Дамп из БД KOI8R успешно восстановлен в UTF8. Кодировка преобразована корректно; возможные проблемы —            |
|        |        |            | несовместимые символы, различия коллатора, зависимость от локали сервера.                                       |
|   3    |   2    | Выполнено  | Изменение lc_time влияет на вывод форматированных дат, но не на EXTRACT(DOW), так как он работает численно.     |                        | 
```
